...
async function getAllRounds(): Promise<{ year: number; round: string }[]> {
  ...
  try {
    ...
    const knownFiles = [
      // 2013年
      '2013P1', '2013P2', '2013Q1', '2013Q2', '2013G1', '2013G2', '2013G3', '2013G4', '2013S1', '2013S2', '2013F',
      // 2014年
      '2014P1', '2014P2', '2014Q1', '2014Q2', '2014G1', '2014G2', '2014G3', '2014S', '2014F',
      // 2015年
      '2015P1', '2015P2', '2015Q1', '2015Q2', '2015G1', '2015G2', '2015G3', '2015G4', '2015S', '2015F',
      // 2016年
      '2016P1', '2016P2', '2016Q1', '2016Q2', '2016G1', '2016G2', '2016G3', '2016S1', '2016S2', '2016F',
      // 2017年
      '2017P1', '2017P2', '2017Q1', '2017Q2', '2017G1', '2017G2', '2017G3', '2017S', '2017F',
      // 2018年
      '2018P1', '2018P2', '2018Q1', '2018Q2', '2018G1', '2018G2', '2018G3', '2018S', '2018F',
      // 2019年
      '2019P1', '2019P2', '2019Q', '2019G1', '2019G2', '2019G3', '2019G4', '2019S', '2019F',
      // 2020年
      '2020P1', '2020P2', '2020R', '2020I1', '2020I2', '2020I3', '2020F',
      // 2021年
      '2021P1', '2021P2', '2021R1', '2021R2', '2021R3', '2021I1', '2021I2', '2021I3', '2021I4', '2021F',
      // 2022年
      '2022P1', '2022P2', '2022R', '2022I1', '2022I2', '2022I3', '2022F',
      // 2023年
      '2023P1', '2023P2', '2023I1', '2023I2', '2023I3', '2023F',
      // 2024年
      '2024P1', '2024P2', '2024R', '2024I1', '2024I2', '2024I3', '2024F',
      // 2025年
      '2025P1'
    ];
